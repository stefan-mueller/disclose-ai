...
categoryGate = {
  ...
  const selectAllOption = el("label", {
    ...
    el("span", { class: "gaidet-checkbox-box" }, []),
    el("span", {}, "My assignment allows using AI without limiting it to specific catewgories — select all")
  ]);
  ...
  const noGuidanceWarning = noGuidance
    ? el("div", { class: "gaidet-category-gate-warning" }, [
        el("strong", {}, "Don’t guess. "),
        "Without any guidance from your assignment brief or module, this tool can’t help you work out whether AI use is even allowed. Ask your lecturer whether (and how) AI may be used before doing anything else."
      ])
    : null;
...
form = {
  ...
  return locked ? lockBox(categoryEl, `Locked: if you're allowed to use AI for “${cat.label}”, tick it in Step 1 above to unlock this category.`) : categoryEl;
  })));
}
```
