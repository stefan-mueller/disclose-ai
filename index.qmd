...
declarationHtml = {
  ...
  const headingHtml = `<p><strong>AI Disclosure Declaration</strong></p><p><strong>AI tools used:</strong> ${overallToolsPart}</p>`;
...
**Questions, errors, or suggestions.** If you have questions about this policy or how this site handles data, contact [Stefan Müller](https://muellerstefan.net). If you spot an error or have an improvement suggestion, feel free to open an issue or pull request on [GitHub](https://github.com/stefan-mueller/disclose-ai).
