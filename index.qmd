...
```{ojs}
//| echo: false
step2Label = el("p", { class: "gaidet-step-label" }, "Step 2: Tick every task where you used AI")
```
...
You can create a declaration in three steps: 

- **Step 1:** tell it which categories of AI use your assignment or module permits.
- **Step 2:** go through the unlocked categories below, tick every task where you delegated work to AI, then add the tool(s) you used and a short description for each. Give the exact model or version where you can (e.g. GPT-5.5), since capability varies a lot between versions. 
