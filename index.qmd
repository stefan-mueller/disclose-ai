...
categoryGate = {
  ...
  const selectAllOption = el("label", {
    ...
    el("span", { class: "gaidet-checkbox-box" }, []),
    el("span", {}, "My assignment allows using AI without limiting it to specific categories — select all")
  ]);
  ...
  const noGuidanceWarning = noGuidance
    ? el("div", { class: "gaidet-category-gate-warning" }, [
        ...
        "This tool can’t tell you whether AI use is allowed on your assignment. Check the syllabus or ask your lecturer before using AI or generating a declaration."
      ])
    : null;
