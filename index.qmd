...
form = {
  ...
  const categoryEl = el("div", { class: "gaidet-category" }, [
    ...
    ...cat.items.map(item => {
      ...
      if (detailsDiv) {
        detailsDiv.addEventListener("focusout", () => confirmIfComplete());
...
Learn more about generative AI declaration generators: Suchikova, Y., Tsybuliak, N., Teixeira da Silva, J. A., & Nazarovets, S. (2026). [GAIDeT (Generative AI Delegation Taxonomy): A Taxonomy for Humans to Delegate Tasks to Generative Artificial Intelligence in Scientific Research and Publishing](https://doi.org/10.1080/08989621.2025.2544331). *Accountability in Research*, *33*(3).
