...
This website offers a structured, task-by-task checklist for recording your AI use and automatically generates a clear disclosure statement. It adapts the [GAIDeT Declaration Generator](https://panbibliotekar.github.io/gaidet-declaration/) ([Suchikova et al. 2026](https://doi.org/10.1080/08989621.2025.2544331)) for university assignments.

Select every task a generative AI tool helped you with, then add a short description of what you asked it to do and how you used the output. Your answers are automatically formatted into a declaration at the end of this page, ready to copy and adjust as needed.
