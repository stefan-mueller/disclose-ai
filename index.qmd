...
form = {
  ...
  const categoryEl = el("div", { class: "gaidet-category" }, [
    ...
    ...cat.items.map(item => {
      ...
      // code (like confirmIfComplete, below) still running in this same render.
      ...
      function confirmIfComplete() {
        ...
        // just committed a moment ago in this same render (e.g. adding a tool
        // right before clicking Confirm).
        const currentCustomLabel = customLabelInput ? customLabelInput.value : (selections[key]?.customLabel ?? "");
      ...
      const detailsDiv = checked ? el("div", { class: "gaidet-item-details" }, [
        ...
        el("div", { class: "gaidet-sentence-wrap" }, [
          sentenceTextarea,
          el("div", { class: "gaidet-sentence-footer" }, [proceedBtn])
        ]),
