...
If you have permission to use AI, but need to disclose your use in a clear, structured way, this tool is for you: a structured, task-by-task checklist for recording your AI use, adapted from the [GAIDeT Declaration Generator](https://panbibliotekar.github.io/gaidet-declaration/) ([Suchikova et al. 2026](https://doi.org/10.1080/08989621.2025.2544331)).

The process of disclosing your AI use is straightforward: select every task a generative AI tool helped with, describe what you asked it to do and how you used and validated the output, and get a ready-to-copy declaration at the end of this page.
