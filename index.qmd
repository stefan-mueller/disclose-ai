...
This tool generates a plain-text AI Disclosure Declaration that summarises which generative AI tools you used, and how, so you can paste it into your assignment appendix. It is completely **free to use**, **fully open source**, and **never leaves your browser** — see the [privacy note](#notes-and-disclaimers) at the end of this page for details.


Built by [Stefan Müller](https://muellerstefan.net) with the support of Claude Code. This idea is inspired by the [GAIDeT Declaration Generator](https://panbibliotekar.github.io/gaidet-declaration/) ([Suchikova et al. 2026](https://doi.org/10.1080/08989621.2025.2544331)), adapted for university assignments.



## What is this tool for?

Generative AI use among students continues to grow: according to the [Student Generative AI Survey 2026](https://www.hepi.ac.uk/wp-content/uploads/2026/03/HEPI-Report-199-Gen-AI-Survey-2026.pdf) (Rose Stephenson and Charlotte Armstrong, HEPI), 94% of students use generative AI to help with assessed work. Some assignments prohibit its use; others permit it but require disclosure — and clear guidance on *how* to disclose isn't always available. This tool offers a structured, task-by-task checklist for recording your AI use, so you can produce a clear disclosure statement even when your institution or module hasn't provided one of its own. To be explicit: this tool does **not** encourage or endorse the use of generative AI in your assignments — it exists only to help you disclose whatever use you make of it, once you have confirmed that use is permitted.
    ...
    ...cat.items.map(item => {
      ...
      function buildToolPicker() {
        ...
        const input = el("input", {
          ...
          placeholder: hasSelection ? "+ Add another tool" : "Start typing to add tool”…",
          autocomplete: "off"
        });
          ...
          currentSelected().forEach(entry => {
            ...
            if (entry.needsVersion) {
              ...
              row.append(el("input", {
                ...
                placeholder: suggestedVersion ? `e.g., ${suggestedVersion}` : "Model/version (e.g., GPT-5.5)",
                value: entry.version,
                oninput: debounce((e) => {
