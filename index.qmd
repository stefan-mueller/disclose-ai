...
This tool is built specifically for student coursework. If you're a researcher looking to document AI use in a publication or grant application, check out the [related literature and tools](#related-literature-and-advice) below for options aimed at research rather than teaching.
...
stepsIntro = el("div", { class: "gaidet-steps" }, [
  el("div", { class: "gaidet-step" }, [
    ...
    el("div", { class: "gaidet-step-body" }, [
      ...
      el("p", {}, "Tick the categories of AI use your assignment or course/module permits.")
    ])
  ]),
  el("div", { class: "gaidet-step" }, [
...
// see the "Analytics" section of the Privacy Policy page, which discloses
...
```{ojs}
//| echo: false
// When true, the assignment/course/module gives no guidance at all on AI use.
        ...
        el("input", {
          ...
          onchange: (e) => {
            if (e.target.checked) {
              ...
              document.getElementById("gaidet-output-section")?.scrollIntoView({ behavior: "smooth", block: "start" });
            }
          }
        }),
        " Yes"
...
aiasSelector = {
  ...
  return el("div", { class: "gaidet-aias-question" }, [
    ...
    el("p", { class: "gaidet-tool-instructions" }, [
      "If your assignment brief or course/module states a level from the ",
...
categoryGate = {
  ...
  const noGuidanceOption = el("label", {
    ...
    el("span", { class: "gaidet-checkbox-box" }, []),
    el("span", {}, "My assignment/course/module gives no guidance at all on AI use")
  ]);

  const noGuidanceWarning = noGuidance
    ? el("div", { class: "gaidet-category-gate-warning" }, [
        el("strong", {}, "Don’t assume. "),
        "Treat no guidance as AI not being permitted until your course/module coordinator confirms otherwise, not as permission by default. Ask before using AI or generating a declaration."
      ])
    : null;
  ...
  return el("div", { class: "gaidet-category-gate" }, [
    ...
    el("p", { class: "gaidet-tool-instructions" }, "Check the categories your assignment brief or course/module instructions allow. Everything else stays locked below until you check it here, so tick only what is permitted."),
...
form = {
  ...
  if (allowedCategories.size === 0) {
    return el("div", { class: "gaidet-output-placeholder gaidet-output-placeholder-warning" }, [
      el("p", {}, [
        "Complete ",
        el("a", { href: "#generate-declaration" }, "Step 1"),
        " above first. Once you tick the categories of AI use your assignment allows, they’ll appear here for you to describe."
      ])
    ]);
  }
...
Before you begin, please read the [privacy policy](privacy.qmd) and [disclaimer of responsibility](#disclaimer-of-responsibility) at the end of this page for details.
...
outputBox = {
  ...
  const outputDiv = el("div", { class: "gaidet-output", id: "gaidet-output-section" }, [
    ...
    // Copy/download sit below the declaration, not above it, so a student
    // reads what was generated before acting on it.
    (showDeclaration && !showConfirmPrompt) ? el("div", { class: "gaidet-output-actions-secondary" }, [
      el("button", {
    ...
    (showDeclaration && !showConfirmPrompt) ? el("p", { class: "gaidet-output-note" }, [
      "I recommend reviewing and adjusting the declaration to fit your own voice and your course/module's requirements before submitting."
    ]) : null
  ]);
...
## About the maintainer and tool


[Stefan Müller](https://stefanmueller.ie) built this tool with assistance from AI Coding Agents, under his direction.

I would love to hear how you are using this tool and any suggestions for improving it. Please share your thoughts via this [short feedback form](https://forms.cloud.microsoft/e/nSGgCVHRQg).

## Information for lecturers

This section answers the questions lecturers have asked most often after testing the tool with their own students.

::: {.gaidet-faq}
<details class="gaidet-faq-item">
<summary>Where do these categories come from?</summary>
<div class="gaidet-faq-body">
The categories in Step 1 above are drawn from task categories used in student surveys and existing AI disclosure guidelines. They form a checklist of common use cases, not a recommendation that students use AI for all, or indeed any, of them. Whether AI is appropriate for a given category still depends entirely on your assignment brief and your own instructions.
...
<details class="gaidet-faq-item">
<summary>How can I phrase permitted AI use in my assignment brief?</summary>
<div class="gaidet-faq-body">
...
<details class="gaidet-faq-item">
<summary>What if my course/module has not settled on an AI policy yet?</summary>
<div class="gaidet-faq-body">
...
<details class="gaidet-faq-item">
<summary>How do I cite this tool?</summary>
<div class="gaidet-faq-body">
...
<details class="gaidet-faq-item">
<summary>Related literature and advice</summary>
<div class="gaidet-faq-body">
...
This tool is provided purely as a free, unofficial aid to help you structure your own AI-use disclosure. It is not legal, academic, or official institutional guidance, and using it does not constitute compliance with any university, School, programme, or course/module policy.
...
You are solely responsible for checking your own university's and course/module's specific generative AI policies and citation requirements, and for confirming directly with your lecturer or course/module coordinator whether, and how, AI tools may be used before you submit any work. The author cannot be held legally accountable for any reliance placed on this tool.
...
See the [privacy policy](privacy.qmd) for full details on what data this tool does, and does not, collect.
