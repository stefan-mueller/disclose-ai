...
This tool helps students disclose their use of generative AI in university assignments. It generates a plain-text declaration summarising which AI tools you used and how, ready to paste into your appendix. It is free to use, fully open source, and never leaves your browser. See the [privacy note](#note-on-privacy) and [disclaimer of responsibility](#disclaimer-of-responsibility) at the end of this page for details.


## What is this tool for?

Generative AI use among students continues to grow. According to the [Student Generative AI Survey 2026](https://www.hepi.ac.uk/wp-content/uploads/2026/03/HEPI-Report-199-Gen-AI-Survey-2026.pdf), 94% of students use generative AI to help with assessed work. Some assignments prohibit its use; others permit it but require disclosure, and clear guidance on *how* to disclose isn’t always available.

This gap is what the tool below addresses. It offers a structured, task-by-task checklist for recording your AI use, so you can produce a clear disclosure statement even when your institution or module hasn’t provided one of its own. It adapts the [GAIDeT Declaration Generator](https://panbibliotekar.github.io/gaidet-declaration/) ([Suchikova et al. 2026](https://doi.org/10.1080/08989621.2025.2544331)) for university assignments.

Before you use it, one point needs to be explicit: this tool does not encourage or endorse the use of generative AI in your assignments. It exists only to help you disclose whatever use you make of it, once you have confirmed that use is permitted.

To use it, select every task a generative AI tool assisted you with. For each one you select, add a short description of what you asked the AI to do and how you used its output. Your answers are automatically formatted into a declaration at the end of this page, ready for you to copy and adjust as needed.
...
>Müller, Stefan (2026). *AI Disclosure Statement Generator*. <https://discloseai.netlify.app>
...
>Suchikova, Yana, Tsybuliak, Natalia, Teixeira da Silva, Jaime A., & Nazarovets, Serhii (2026). [GAIDeT (Generative AI Delegation Taxonomy): A Taxonomy for Humans to Delegate Tasks to Generative Artificial Intelligence in Scientific Research and Publishing](https://doi.org/10.1080/08989621.2025.2544331). *Accountability in Research*, *33*(3).
