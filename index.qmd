...
Select every task you delegated to a generative AI tool. For each one selected, add one sentence describing what you asked the AI to do and how you used its output. When you are finished, copy the declaration at the end of this page and make manual adjustments where needed.
...
outputBox = {
  ...
  const warning = (incomplete && copyWarning)
    ? el("div", { class: "gaidet-warning" }, noTasks
        ? "Please tick at least one task below before copying the declaration."
        : [
            "Please add a short description and at least one tool before copying the declaration, for:",
  ...
  return el("div", { class: "gaidet-output" }, [
    ...
    success,
    incomplete
      ? el("p", { class: "gaidet-output-placeholder" }, "Your declaration will appear here once every ticked task has a tool and a one-sentence description.")
