...
categoryGate = {
  ...
  const noGuidanceWarning = noGuidance
    ? el("div", { class: "gaidet-category-gate-warning" }, [
        ...
        "Treat no guidance as AI not being permitted until your module coordinator confirms otherwise, not as permission by default. Ask before using AI or generating a declaration."
      ])
    : null;
