...
<style>
/* The default Quarto title block is replaced by the hero banner below on
   this page only. Scoped here (not in styles.css) so it doesn't also hide
   the title on privacy.qmd / lecturers.qmd, which have no hero of their own. */
#title-block-header {
  display: none;
}
</style>
...
<p class="site-header__kicker">
<span>&gt; Disclose how you used AI in your  assignment</span>
<span class="site-header__cursor" aria-hidden="true"></span>
</p>
<h1 class="site-header__title">AI Disclosure Generator</h1>
<p class="site-header__lede">A free, open-source tool for students that protects your privacy and guides you step by step through generating clear AI-use disclosure statements.</p>
</div>
</header>
...
This tool is built specifically for student coursework. That said, if you're a researcher looking to document AI use in a publication or grant application, check out the [related literature and tools](lecturers.qmd#related-literature-and-advice) for options aimed at research rather than teaching.
...
aiasSelector = {
  ...
  return el("div", { class: "gaidet-aias-question" }, [
    ...
    el("p", { class: "gaidet-tool-instructions" }, [
      "If your assignment brief or course/module instructions state a level from the ",
...
If you are using this tool in your teaching or research, you can cite it as:

> Müller, Stefan. *AI Disclosure Generator*. <https://disclose-ai.app>

## Information for lecturers

If you're a lecturer, see the [dedicated page for lecturers](lecturers.qmd) for answers to the questions lecturers have asked most often after testing the tool with their own students, including where the Step 1 categories come from, how to phrase permitted AI use in an assignment brief, how to cite this tool, and related literature and advice.
...
The author, Stefan Müller, and any contributors accept **no responsibility or liability whatsoever** for how this tool is used, for whether the tasks and tools listed by the user constitute a complete account of all generative AI use in connection with the relevant work, or for whether such use is declared honestly and in good faith. Nor do they accept liability for any academic, disciplinary, legal, or other consequences arising from the tool's use or misuse.
