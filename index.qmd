...
This tool helps students disclose their use of generative AI in university assignments. It generates a declaration summarising which AI tools you used and how, ready to be added to your assignment submission. It is free to use, fully open source, and runs entirely in your browser. Nothing you enter is ever sent to a server. See the [privacy policy](#privacy-policy) and [disclaimer of responsibility](#disclaimer-of-responsibility) at the end of this page for details.
